...
export const ETHOS_IMAGES = [
  {
    ...
    x: -9,
    y: 391,
    caption: "I love to host dinner parties, and explore different cuisines",
  },
  {
    src: "/images/contact/doublerainbow.png",
    x: 421,
    y: 44,
    caption: "I saw a double rainbow on my birthday in Kauai this year. My 2026 good luck charm.",
  },
  {
  ...
  },
  {
    ...
    x: 1364,
    y: 220,
    caption: "Inspired by the art in Casa Gilardi, Mexico City.",
  },
  {
    src: "/images/contact/reading.png",
    x: 488,
    y: 747,
    caption: "Current read: “Educated” by Tara Westover.",
  },
  {
